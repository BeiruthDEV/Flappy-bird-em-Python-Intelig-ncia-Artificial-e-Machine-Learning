...
def desenhar_tela(tela, passaros, canos, chao, pontos, ai, geracao, vivos, recorde):
    ...
    if ai:
        texto_gen = FONTE_PONTOS.render(f"Geração: {geracao}", True, (255, 255, 255))
        tela.blit(texto_gen, (10, 10))
        texto_vivos = FONTE_PONTOS.render(f"Vivos: {vivos}", True, (0, 255, 0))
        tela.blit(texto_vivos, (10, 50))
        texto_best = FONTE_PONTOS.render(f"Recorde: {recorde}", True, (255, 215, 0))
        tela.blit(texto_best, (10, 90))
